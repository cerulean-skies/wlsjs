...
/**
 Memo encryption has failed in the browser before.  An Error will be thrown if a memo can't be encrypted and decrypted.
 */
function checkEncryption() {
  if (encodeTest === undefined) {
    ...
    try {
      ...
      var pubkey = 'WLS8m5UgaFAAYQRuaNejYdS8FVLVp9Ss3K1qAVk5de6F8s3HnVbvA';
