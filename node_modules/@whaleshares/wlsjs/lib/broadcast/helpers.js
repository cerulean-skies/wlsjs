...
exports = module.exports = function (wlsBroadcast) {
  wlsBroadcast.addAccountAuth = function (_ref, cb) {
    ...
    _api2.default.getAccounts([username], function (err, _ref2) {
      ...
      wlsBroadcast.accountUpdate(signingKey, userAccount.name, owner, active, posting, userAccount.memo_key, userAccount.json_metadata, cb);
    });
  };

  wlsBroadcast.removeAccountAuth = function (_ref4, cb) {
  ...
  wlsBroadcast.addKeyAuth = function (_ref7, cb) {
  ...
  wlsBroadcast.removeKeyAuth = function (_ref10, cb) {
