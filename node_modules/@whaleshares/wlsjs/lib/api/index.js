...
var WLSJS = function (_EventEmitter) {
  _inherits(WLSJS, _EventEmitter);

  function WLSJS() {
    var options = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};

    _classCallCheck(this, WLSJS);

    var _this = _possibleConstructorReturn(this, (WLSJS.__proto__ || Object.getPrototypeOf(WLSJS)).call(this, options));
...
var wlsjs = new WLSJS(_config2.default);
